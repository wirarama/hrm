...
?>
	...
	<script type="text/javascript">
	<!--
	var letters=' ABCÇDEFGHIJKLMNNÑOPQRSTUVWXYZabcçdefghijklmnñopqrstuvwxyzàáÀÁéèÈÉíìÍÌïÏóòÓÒúùÚÙüÜ'
	var letters1='ABCÇDEFGHIJKLMNNÑOPQRSTUVWXYZabcçdefghijklmnñopqrstuvwxyzàáÀÁéèÈÉíìÍÌïÏóòÓÒúùÚÙüÜ'
	...
	<?
	/*
	if($_GET['p']=='task_add' || $_GET['p']=='task_edit'){
		task_js_form_head();
	}*/
	?>
	<!--General CSS-->
