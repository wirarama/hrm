...
$enable_submit = array('overtime_add','overtime_edit','annual_leave_add','annual_leave_edit');
$enable_time = array('overtime_add','overtime_edit','overtime_list','task_add','task_edit','task_list');
$page=20;
//-----------------------------------------------------------------
//		login verification
//-----------------------------------------------------------------
