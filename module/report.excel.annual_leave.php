...
require('module.annual_leave.php');
...
$worksheet =& $workbook->addworksheet('Annual Leave');
...
$col_width = array(30,25,25,15,40,15);
for ($i=0;$i<6;$i++){
	$worksheet->set_column($i,$i,$col_width[$i]);
}
//
$judul = 'Annual Leave_Report_'.date("d-M-Y_h:i:A");
$title_col1 = array('Annual Leave Report','','','','','');
//
